...
@ManagedBean
@ViewScoped
public class RptA10V1Action implements Serializable {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbHousingfundTxn selectedRecord;
    private boolean isBizBranch; //是否业务网点

    private String title;

    private LazyDataModel<OdsbHousingfundTxn> lazyDataModel;
    ...
    public String onQuery() {
        try {
            ...
            oplog.setActionId("RptA10V1_onQuery");
            oplog.setActionName("住房公积金交易情况数据:查询");
            ...
            this.lazyDataModel = new RptA10V1LazyDataModel(odsbRptService.getOdsbRptMapper(), this.paramBean);
        } catch (Exception e) {
    ...
    public OdsbHousingfundTxn getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(OdsbHousingfundTxn selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public LazyDataModel<OdsbHousingfundTxn> getLazyDataModel() {
        return lazyDataModel;
    }

    public void setLazyDataModel(LazyDataModel<OdsbHousingfundTxn> lazyDataModel) {

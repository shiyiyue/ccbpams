...
@ManagedBean
@ViewScoped
public class RptA11V1Action implements Serializable {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbPayagentTxn selectedRecord;
    private boolean isBizBranch; //是否业务网点

    private String custBasePopWinUrl;
    private String title;

    private LazyDataModel<OdsbPayagentTxn> lazyDataModel;
    ...
    public String onQuery() {
        try {
            ...
            oplog.setActionId("RptA11V1_onQuery");
            oplog.setActionName("代发业务交易明细情况数据:查询");
            ...
            this.lazyDataModel = new RptA11V1LazyDataModel(odsbRptService.getOdsbRptMapper(), this.paramBean);
        } catch (Exception e) {
    ...
    public OdsbPayagentTxn getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(OdsbPayagentTxn selectedRecord) {
    ...
    public LazyDataModel<OdsbPayagentTxn> getLazyDataModel() {
        return lazyDataModel;
    }

    public void setLazyDataModel(LazyDataModel<OdsbPayagentTxn> lazyDataModel) {

 ...
 * Date: 2013-03-28
 */
public class RptA09V1LazyDataModel extends LazyDataModel<OdsbPayrollTxn> {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbRptMapper odsbRptMapper;

    public RptA09V1LazyDataModel(OdsbRptMapper odsbRptMapper, BasePagedQryParamBean paramBean) {
        this.odsbRptMapper = odsbRptMapper;
        this.paramBean = paramBean;
    }

    @Override
    public List<OdsbPayrollTxn> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
        List<OdsbPayrollTxn> dataList;
        try {
            ...
            dataList = this.odsbRptMapper.selectRptA09V1Records(param);
        } catch (Exception e) {
        ...
        if (super.getRowCount() <= 0) {
            int total = odsbRptMapper.countRptA09V1Records(paramBean);

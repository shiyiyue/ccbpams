 ...
 * Date: 2013-03-28
 */
public class RptA11V1LazyDataModel extends LazyDataModel<OdsbPayagentTxn> {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbRptMapper odsbRptMapper;

    public RptA11V1LazyDataModel(OdsbRptMapper odsbRptMapper, BasePagedQryParamBean paramBean) {
        this.odsbRptMapper = odsbRptMapper;
        this.paramBean = paramBean;
    }

    @Override
    public List<OdsbPayagentTxn> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
        List<OdsbPayagentTxn> dataList;
        try {
            ...
            dataList = this.odsbRptMapper.selectRptA11V1Records(param);
        } catch (Exception e) {
        ...
        if (super.getRowCount() <= 0) {
            int total = odsbRptMapper.countRptA11V1Records(paramBean);

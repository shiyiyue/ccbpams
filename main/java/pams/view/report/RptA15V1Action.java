...
@ManagedBean
@ViewScoped
public class RptA15V1Action implements Serializable {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbEbankSign selectedRecord;
    private boolean isBizBranch; //是否业务网点

    private String custBasePopWinUrl;
    private String title;

    private LazyDataModel<OdsbEbankSign> lazyDataModel;
    ...
    public String onQuery() {
        try {
            ...
            oplog.setActionId("RptA15V1_onQuery");
            oplog.setActionName("新签约客户签约当日交易笔数:查询");
            ...
            this.lazyDataModel = new RptA15V1LazyDataModel(odsbRptService.getOdsbRptMapper(), this.paramBean);
        } catch (Exception e) {
    ...
    public OdsbEbankSign getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(OdsbEbankSign selectedRecord) {
    ...
    public LazyDataModel<OdsbEbankSign> getLazyDataModel() {
        return lazyDataModel;
    }

    public void setLazyDataModel(LazyDataModel<OdsbEbankSign> lazyDataModel) {

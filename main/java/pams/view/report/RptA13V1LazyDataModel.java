 ...
 * Date: 2013-03-28
 */
public class RptA13V1LazyDataModel extends LazyDataModel<OdsbStlcrdBal> {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbRptMapper odsbRptMapper;

    public RptA13V1LazyDataModel(OdsbRptMapper odsbRptMapper, BasePagedQryParamBean paramBean) {
        this.odsbRptMapper = odsbRptMapper;
        this.paramBean = paramBean;
    }

    @Override
    public List<OdsbStlcrdBal> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
        List<OdsbStlcrdBal> dataList;
        try {
            ...
            dataList = this.odsbRptMapper.selectRptA13V1Records(param);
        } catch (Exception e) {
        ...
        if (super.getRowCount() <= 0) {
            int total = odsbRptMapper.countRptA13V1Records(paramBean);

 ...
 * Date: 2015-01-15
 */
public class RptA14V1LazyDataModel extends LazyDataModel<OdsbGrbNewcust> {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private BasePagedQryParamBean paramBean;
    private OdsbRptMapper odsbRptMapper;

    public RptA14V1LazyDataModel(OdsbRptMapper odsbRptMapper, BasePagedQryParamBean paramBean) {
        this.odsbRptMapper = odsbRptMapper;
        this.paramBean = paramBean;
    }

    @Override
    public List<OdsbGrbNewcust> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
        List<OdsbGrbNewcust> dataList;
        try {
            ...
            dataList = this.odsbRptMapper.selectRptA14V1Records(param);
        } catch (Exception e) {
        ...
        if (super.getRowCount() <= 0) {
            int total = odsbRptMapper.countRptA14V1Records(paramBean);

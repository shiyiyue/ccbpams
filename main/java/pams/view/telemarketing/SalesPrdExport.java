...
//            response.setContentType("application/x-download");
            ...
            svplinfListJJ = salesMapper.selectForPrdid("01",operid,"SVTFUNDTYPE",strTxnDate);   //基金
            svplinfListBX = salesMapper.selectForPrdid("02",operid,"SVTINSURETYPE",strTxnDate);   //保险
            svplinfListLC = salesMapper.selectForPrdid("03",operid,"SVTFPTYPE",strTxnDate);   //理财
            svplinfListCK = salesMapper.selectForPrdid2("04",operid,strTxnDate);   //-存款
            svplinfListJJK = salesMapper.selectForPrdid2("05",operid,strTxnDate);   //借记卡
            svplinfListXYK = salesMapper.selectForPrdid2("06",operid,strTxnDate);   //信用卡
            svplinfListDK = salesMapper.selectForPrdid2("07",operid,strTxnDate);   //贷款
            svplinfListDZ = salesMapper.selectForPrdid2("08",operid,strTxnDate);   //电子银行
            svplinfListHJ = salesMapper.selectForPrdid2("09",operid,strTxnDate);   //黄金
            svplinfListQT = salesMapper.selectForPrdid2("10",operid,strTxnDate);   //其它
            ...
            cellHead.setCellValue(new HSSFRichTextString("网点业绩记录表"));
...
//            response.setContentType("application/x-download");
            response.setContentType("application/msexcel");
            Ptdept dept = ptdeptmapper.selectByOperid(operid);
            svplinfListJJ = salesMapper.selectForOperid("01",operid,"SVTFUNDTYPE",strTxnDate);   //基金
            svplinfListBX = salesMapper.selectForOperid("02",operid,"SVTINSURETYPE",strTxnDate);   //保险
            svplinfListLC = salesMapper.selectForOperid("03",operid,"SVTFPTYPE",strTxnDate);   //理财
            svplinfListCK = salesMapper.selectForOperid2("04",operid,strTxnDate);   //-存款
            svplinfListJJK = salesMapper.selectForOperid2("05",operid,strTxnDate);   //借记卡
            svplinfListXYK = salesMapper.selectForOperid2("06",operid,strTxnDate);   //信用卡
            svplinfListDK = salesMapper.selectForOperid2("07",operid,strTxnDate);   //贷款
            svplinfListDZ = salesMapper.selectForOperid2("08",operid,strTxnDate);   //电子银行
            svplinfListHJ = salesMapper.selectForOperid2("09",operid,strTxnDate);   //黄金
            svplinfListQT = salesMapper.selectForOperid2("10",operid,strTxnDate);   //其它
            int[] arry = {svplinfListJJ.size(),svplinfListBX.size(),svplinfListLC.size(),svplinfListCK.size(),
            svplinfListJJK.size(),svplinfListXYK.size(),svplinfListDK.size(),svplinfListDZ.size(),svplinfListHJ.size(),
            svplinfListQT.size()};
            int maxLen = this.getMax(arry);
    ...
    private void setContent2(HSSFSheet sheet,HSSFCellStyle cellstyle,HSSFCellStyle cellstyleRight,HSSFCellStyle cellstyleCenter
        ...
        for (int i = 0;i < maxLength;i++) {
            ...
            if (i+1 <= svplinfListJJ.size()) {
                ...
                myCreateCell(cellIndexStartJJ - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListBX.size()) {
                ...
                myCreateCell(cellIndexStartBX - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListLC.size()) {
                ...
                myCreateCell(cellIndexStartLC - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListCK.size()){
                ...
                myCreateCell(cellIndexStartCK - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListJJK.size()){
                ...
                myCreateCell(cellIndexStartJJK - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListXYK.size()){
                ...
                myCreateCell(cellIndexStartXYK - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListDK.size()){
                ...
                myCreateCell(cellIndexStartDK - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListDZ.size()){
                ...
                myCreateCell(cellIndexStartDZ - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListHJ.size()){
                ...
                myCreateCell(cellIndexStartHJ - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号
            ...
            if (i+1 <= svplinfListQT.size()){
                ...
                myCreateCell(cellIndexStartQT - 1,String.valueOf(i+1), row, cell,cellstyleCenter); //序号

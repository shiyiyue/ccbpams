...
function onUserDocumentLoad()
{
		...
		var menuText="添加机构,,,,/images/insert.gif,add;-,0,,,,;修改机构,,,,/images/property.gif,edit;";
		//var menuText="添加部门,,,,/images/insert.gif,add;";
		menuText =menuText+"-,0,,,,;删除机构,,,,/images/delete.gif,delete;";
		...
		if (retStr != false)
		{
			...
			var nRoot = vNodes.add("", "", "0", "机构管理", "/images/domain.gif");
